          ...
          <Box style={{width:'100%'}}  key={slide.id}
           sx={{display:'flex', justifyContent:'center'}}>
            <Box 
              ...
              <Box  sx={{      }}>
                  <Typography sx={{fontWeight:'600', fontSize:'1.1rem', color:'color2', marginBlock:'0.8rem'}} >{slide.title} </Typography> 
                  <Typography  sx={{textOverflow:'ellipsis' , marginInline:'10%',width:'80%', height:'50px' ,
                  overflow:'hidden', whiteSpace:'pre-line'}}>{slide.subtitle} </Typography>... 
              </Box>

              <Box  sx={{marginBlock:'0.7rem'  }}>
